    ...
    <div id="projects" className="container project__container">
      ...
      <Row className="mt-5">
        <Col className="mb-4" sm={12} md={6} lg={6}>
          ...
          <Carousel>
            <Carousel.Item>
              <img className="d-block w-100 rounded-3" src={car1} alt="First slide" />
            </Carousel.Item>
            <Carousel.Item>
              <img className="d-block w-100 rounded-3" src={car2} alt="Second slide" />
            </Carousel.Item>
            <Carousel.Item>
              <img className="d-block w-100 rounded-3" src={car3} alt="Third slide" />
            </Carousel.Item>
          </Carousel>
          </div>
        </Col>
        <Col  sm={12} md={6} lg={6}>
          <div data-aos="zoom-in" className="project__info">
            ...
            <h3>Overview</h3>
            <p>
              Users are able to add a review and that review appears on the home
              page. A User can be able to buy a product and remove his order. An
              admin is able to manage all orders, make another admin, add more
              products on the products page.
            </p>
            <span>
              <i className="fas fa-eye"></i>{" "}
              <a rel="noreferrer" href="https://infinity-car-d7c25.web.app/" target="_blank">
                Live
              </a>{" "}
              |{" "}
              <a
      ...
      <Row className="mt-5">
        <Col className="mb-4"  sm={12} md={6} lg={6}>
          ...
          <Carousel>
            <Carousel.Item>
              <img className="d-block w-100 rounded-3" src={tour1} alt="First slide" />
            </Carousel.Item>
            <Carousel.Item>
              <img className="d-block w-100 rounded-3" src={tour2} alt="Second slide" />
            </Carousel.Item>
            <Carousel.Item>
              <img className="d-block w-100 rounded-3" src={tour3} alt="Third slide" />
            </Carousel.Item>
          </Carousel>
          </div>
        </Col>
        <Col sm={12} md={6} lg={6}>
          <div data-aos="zoom-in" className="project__info">
            ...
            <span>
              <i className="fas fa-eye"></i>{" "}
              <a href="https://infinity-tour.web.app/" target="_blank"
              rel="noreferrer"
              >
                Live
              </a>{" "}
      ...
      <Row className="mt-5">
        <Col className="mb-4"  sm={12} md={6} lg={6}>
          ...
          <Carousel>
            <Carousel.Item>
              <img className="d-block w-100 rounded-3" src={hos1} alt="First slide" />
            </Carousel.Item>
            <Carousel.Item>
              <img className="d-block w-100 rounded-3" src={hos2} alt="Second slide" />
            </Carousel.Item>
            <Carousel.Item>
              <img className="d-block w-100 rounded-3" src={hos3} alt="Third slide" />
            </Carousel.Item>
          </Carousel>
          </div>
        </Col>
        <Col sm={12} md={6} lg={6}>
          <div data-aos="zoom-in" className="project__info">
            ...
            <span>
              <i className="fas fa-eye"></i>{" "}
              <a rel="noreferrer" href="https://infinity-hospital.web.app/" target="_blank">
                Live
              </a>{" "}
              |{" "}
              <a
